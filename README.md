...
В процессе разработки все Python-файлы были отформатированы согласно стандартам PEP 8. 
Из-за особенностей работы isort в Windows некоторые файлы были отформатированы вручную.
